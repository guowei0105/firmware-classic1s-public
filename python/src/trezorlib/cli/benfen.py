...
#     """Sign a base64 encoded of the transaction data(from benfen client serialize-transfer-benfen command)."""
#     address_n = tools.parse_path(address)

#     resp = benfen.sign_tx(client, address_n, base64.b64decode(message))
#     result = {
...
def sign_raw_tx(
    ...
    if data_length is not None:
        data_length = int(data_length)  # 确保转换为整数

    resp = benfen.sign_tx(
        client, address_n, decoded_message, decoded_coin_type, data_length
    )
